...
/**
 * RawMaterial - Domain entity representing a raw material used in product manufacturing.
 *
 * <p>This is a pure domain entity with NO framework annotations. Stock quantities use BigDecimal to
 * support fractional units (e.g., 0.5 kg).
 */
public class RawMaterial {
  ...
  public void update(
      String name, String description, String code, MeasurementUnit unit, BigDecimal unitCost) {
    validateName(name);
    validateCode(code);
    Objects.requireNonNull(unit, "Measurement unit cannot be null");
    validateUnitCost(unitCost);
