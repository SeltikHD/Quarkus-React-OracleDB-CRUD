...
/**
 * BillOfMaterialItem - Value Object representing the quantity of a raw material required to produce
 * one unit of a product.
 *
 * <p>This is part of the Product aggregate's Bill of Materials (BOM).
 */
public record BillOfMaterialItem(RawMaterialId rawMaterialId, BigDecimal quantityRequired) {
   ...
   * @param quantityRequired the quantity needed to produce one unit of the product
