 ...
 *
 * <p><b>HEXAGONAL ARCHITECTURE:</b> This is an INPUT PORT (also called a "driving port" or "primary
 * port"). It defines the use cases that the application exposes to the outside world.
 *
 * <p>The REST API (adapter) will call these methods. The implementation (in the application layer)
 * will orchestrate domain logic and call output ports.
 *
 * <p><b>DESIGN NOTES:</b>
 *
 * <ul>
 *   <li>Uses Command/Query objects for complex inputs (CQRS-inspired)
 *   <li>Returns domain objects, not DTOs
 *   <li>Throws domain exceptions for known error cases
 * </ul>
 */
public interface ProductUseCase {
  ...
  record UpdateProductCommand(String name, String description, String sku, BigDecimal unitPrice) {
