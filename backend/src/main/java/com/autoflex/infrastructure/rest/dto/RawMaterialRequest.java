...
@Schema(
    ...
    description = "Request body for creating or updating a raw material")
public class RawMaterialRequest {
  ...
  @Schema(
      description =
          "Measurement unit (KILOGRAM, GRAM, LITER, MILLILITER, METER, "
              + "CENTIMETER, UNIT, PIECE, PAIR, BOX, ROLL, SHEET)",
      example = "KILOGRAM",
      required = true)
  private String unit;
