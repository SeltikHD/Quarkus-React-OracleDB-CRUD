...
@Schema(
    name = "BillOfMaterialItemRequest",
    description = "Request body for adding a material to a product's BOM")
public class BillOfMaterialItemRequest {
  ...
  @Schema(
      description = "Quantity of raw material needed to produce one unit of the product",
      example = "2.5",
      required = true)
