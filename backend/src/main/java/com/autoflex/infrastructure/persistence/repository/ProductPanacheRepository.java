 ...
 *
 * <p>This is a thin wrapper around Panache that provides standard CRUD operations. Complex queries
 * are implemented in the adapter layer.
 *
 * <p><b>NOTE:</b> This is an infrastructure implementation detail. The domain layer is unaware of
 * Panache.
 */
@ApplicationScoped
