...
/**
 * JPA entity representing the association between a Product and a RawMaterial
 * in the bill of materials (BOM). Each row describes how much of a specific
 * raw material is needed to produce one unit of a product.
 */
@Entity
@Table(name = "PRODUCT_MATERIALS", uniqueConstraints = @UniqueConstraint(columnNames = { "PRODUCT_ID",
		"RAW_MATERIAL_ID" }, name = "UK_PRODUCT_MATERIAL"))
