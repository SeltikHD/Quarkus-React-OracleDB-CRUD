 ...
 *
 * <p><b>HEXAGONAL ARCHITECTURE:</b> This is an INFRASTRUCTURE concern, NOT a domain entity. It
 * exists purely to map to the database schema.
 *
 * <p><b>IMPORTANT DISTINCTION:</b>
 *
 * <ul>
 *   <li>{@code Product} (domain) - Pure business logic, no annotations
 *   <li>{@code ProductJpaEntity} (infrastructure) - JPA mapping, no business logic
 * </ul>
 *
