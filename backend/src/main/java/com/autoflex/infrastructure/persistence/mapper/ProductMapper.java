 ...
 *
 * <p><b>HEXAGONAL ARCHITECTURE:</b> This mapper is part of the infrastructure layer and handles the
 * translation between the pure domain model and the JPA persistence model.
 *
 * <p><b>KEY RESPONSIBILITY:</b> Keep the domain model completely free of JPA annotations by
 * providing explicit mapping logic here.
 */
@ApplicationScoped
public class ProductMapper {
              ...
              .map(
                  m ->
                      BillOfMaterialItem.of(
                          RawMaterialId.of(m.getRawMaterialId()), m.getQuantityRequired()))
  ...
  public ProductJpaEntity toJpaEntity(Product product) {
    ...
    List<ProductMaterialJpaEntity> materialEntities =
