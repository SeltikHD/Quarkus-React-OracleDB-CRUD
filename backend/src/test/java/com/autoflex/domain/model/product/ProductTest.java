 ...
 *
 * <p>These tests verify the domain's business rules and invariants without any infrastructure
 * dependencies (pure unit tests).
 */
...
class ProductTest {
  ...
  class ProductCreation {
    ...
    void shouldUppercaseSku() {
      // When
      Product product = Product.create("Product", null, "abc-123", BigDecimal.TEN, 0);
    ...
    void shouldRejectNullName() {
      assertThatThrownBy(() -> Product.create(null, "Description", "SKU-001", BigDecimal.TEN, 0))
    ...
    void shouldRejectEmptyName() {
      assertThatThrownBy(() -> Product.create("   ", "Description", "SKU-001", BigDecimal.TEN, 0))
          .isInstanceOf(IllegalArgumentException.class)
          .hasMessageContaining("name");
    }
    ...
    void shouldRejectInvalidSku() {
      assertThatThrownBy(() -> Product.create("Product", null, "SKU@001", BigDecimal.TEN, 0))
          .isInstanceOf(IllegalArgumentException.class)
    ...
    void shouldRejectNegativePrice() {
      assertThatThrownBy(
              () -> Product.create("Product", null, "SKU-001", new BigDecimal("-10.00"), 0))
          .isInstanceOf(IllegalArgumentException.class)
    ...
    void shouldRejectNegativeStock() {
      assertThatThrownBy(() -> Product.create("Product", null, "SKU-001", BigDecimal.TEN, -5))
          .isInstanceOf(IllegalArgumentException.class)
